...
public class weather_subs_0 {


public static RemoteObject  _class_globals(RemoteObject __ref) throws Exception{
 //BA.debugLineNum = 1;BA.debugLine="Sub Class_Globals";
 //BA.debugLineNum = 2;BA.debugLine="Public weatherAPIKey As String = \"d6870f22a6a2ce7";
weather._weatherapikey = BA.ObjectToString("d6870f22a6a2ce786ae2e31bb33a1a2f");__ref.setField("_weatherapikey",weather._weatherapikey);
...
Debug.ShouldStop(262144);
weather.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("dd-MM"));
 BA.debugLineNum = 116;BA.debugLine="DateTime.TimeFormat = \"HH:mm\"";
Debug.ShouldStop(524288);
weather.__c.getField(false,"DateTime").runMethod(true,"setTimeFormat",BA.ObjectToString("HH:mm"));
 BA.debugLineNum = 117;BA.debugLine="Return(DateTime.Time(ExpDate)  & \" \" & DateTime.D";
Debug.ShouldStop(1048576);
if (true) return (RemoteObject.concat(weather.__c.getField(false,"DateTime").runMethod(true,"Time",(Object)(_expdate)),RemoteObject.createImmutable(" "),weather.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_expdate))));
 BA.debugLineNum = 118;BA.debugLine="Log(DateTime.Date(ExpDate))";
Debug.ShouldStop(2097152);
weather.__c.runVoidMethod ("Log",(Object)(weather.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_expdate))));
...
try {
		Debug.PushSubsStack("ParseWeatherData (weather) ","weather",1,__ref.getField(false, "ba"),__ref,123);
